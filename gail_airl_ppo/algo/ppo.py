...
from gail_airl_ppo.buffer import RolloutBuffer, SeparatedRolloutBuffer
from gail_airl_ppo.network import StateIndependentPolicy, StateFunction, GraphStateIndependentPolicy, GraphStateFunction
...
class PPO(Algorithm):
    ...
    def __init__(self, graph_feature_channels, state_shape, action_shape, device, seed, gamma=0.995,
        ...
        self.critic = GraphStateFunction(
            in_channels=graph_feature_channels,
    ...
    def step(self, env, states, t, step):
        ...
        actions, log_pis = self.explore(states)
        next_states, rewards, dones, extra_info = env.step(actions)   
