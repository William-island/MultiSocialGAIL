...
class CrowdEnv(gym.Env):  # can extend from gym.Env
    ...
    def reset(self, person_id=None):
        ...
        self.start_frame = self.trajectorys[self.agent_id][0][2]
        ...
        self.current_frame = {}
        for id, value in self.frame_data[self.start_frame].items():
            self.current_frame[id] = np.array(value[:2])
        self.past_frames = {}
        self.target_traj = []
        # init
