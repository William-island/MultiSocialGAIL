...
def test_global_similarity_parallel(args):
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=args.flow_num) as executor:
        ...
        for i in range(args.flow_num):
            ...
            executor.submit(test_global_similarity, new_args)
...
if __name__ == '__main__':
    ...
    # test fde fd
    p.add_argument('--model_dir', type=str, default='./logs/CrowdEnv/gail/seed0-20230819-1450/model')
    p.add_argument('--num_models', type=int, default=20)

    # test flow
    p.add_argument('--flow_model_path', type=str, default='./logs/good_models/socialgail/best.pt')
    p.add_argument('--flow_path', type=str, default='./global_flows/flow1.pkl')
